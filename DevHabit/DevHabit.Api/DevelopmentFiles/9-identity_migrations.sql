...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250209131513_Add_Identity') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'identity') THEN
            CREATE SCHEMA identity;
        END IF;
    END IF;
...
BEGIN
    ...
    VALUES ('20250209131513_Add_Identity', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250209161321_Add_RefreshTokens') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250209161321_Add_RefreshTokens') THEN
    INSERT INTO identity."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250209161321_Add_RefreshTokens', '9.0.2');
    END IF;
END $EF$;
COMMIT;
