...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250203103752_Add_Habits') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'dev_habit') THEN
            CREATE SCHEMA dev_habit;
        END IF;
    END IF;
...
BEGIN
    ...
    VALUES ('20250203103752_Add_Habits', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250204104856_Add_Tags') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250204104856_Add_Tags') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250204104856_Add_Tags', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250204114710_Add_HabitTags') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250204114710_Add_HabitTags') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250204114710_Add_HabitTags', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250209104702_Add_Users') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250209104702_Add_Users') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250209104702_Add_Users', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250209173754_Add_UserId_Reference') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250209173754_Add_UserId_Reference') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250209173754_Add_UserId_Reference', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250210150121_Add_GitHubAccessTokens') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250210150121_Add_GitHubAccessTokens') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250210150121_Add_GitHubAccessTokens', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250211142147_Add_Entries') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250211142147_Add_Entries') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250211142147_Add_Entries', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250213135133_Add_EntryImportJobs') THEN
    CREATE TABLE dev_habit.entry_import_jobs (
        ...
        CONSTRAINT fk_entry_import_jobs_users_user_id FOREIGN KEY (user_id) REFERENCES dev_habit.users (id) ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250213135133_Add_EntryImportJobs') THEN
    CREATE INDEX ix_entry_import_jobs_user_id ON dev_habit.entry_import_jobs (user_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM dev_habit."__EFMigrationsHistory" WHERE "migration_id" = '20250213135133_Add_EntryImportJobs') THEN
    INSERT INTO dev_habit."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250213135133_Add_EntryImportJobs', '9.0.2');
    END IF;
END $EF$;
COMMIT;
